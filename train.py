...
# Configuration - Scaled up for RTX 4060 (8GB VRAM) - ~25M parameters
...
MAX_ITERS = 30000  # Increased for better quality
LEARNING_RATE = 1e-3
WEIGHT_DECAY = 0.1
LOG_FREQ = 500  # Less frequent logging for longer training

input_file_path = os.path.join(os.path.dirname(__file__), "input.txt")


# Fetch a simple stories dataset (Aesop's Fables - simple moral stories)
def fetch_data():
    if not os.path.exists(input_file_path):
        # Aesop's Fables from Project Gutenberg - simple, easy to understand stories
        data_url = "https://www.gutenberg.org/cache/epub/11339/pg11339.txt"
        print("Downloading Aesop's Fables dataset...")
